...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
   ...
   endpoints.addEndpoint("1", "Temperatura pozo", endpointType.temperatureSensor);
   endpoints.addEndpoint("2", "Humedad lodazal", endpointType.humiditySensor);
   endpoints.addEndpoint("3", "Temperatura superficie", endpointType.temperatureSensor);
}
