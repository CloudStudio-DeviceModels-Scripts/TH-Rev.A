...
# Configuration Script – T&H - Rev. A

This **Configuration** script is designed for the **T&H** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – T&H Rev. A

Este script de **Configuration** está diseñado para el modelo **T&H** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
